...
* **[LOG-03](#tc-log-03-неверный-пароль)  Неверный пароль.** Проверка системы при вводе ошибочного пароля.
* **[LOG-04](#tc-log-04-sql-инъекция-в-поле-email) SQL-инъекция в поле Email.** Проверка устойчивости к попытке обхода авторизации через внедрение SQL-кода.
### 3. Блок: Валидация (P2)
* **[LOG-05](#tc-log-05-пустые-значения) Пустые значения.** Проверка обязательности полей логина и пароля.
* **[LOG-06](#tc-log-06-чувствительность-к-регистру-в-email) Чувствительность к регистру в Email.** Проверка, что система игнорирует регистр символов в Email при авторизации (Case Insensitivity).
* **[LOG-07](#) ... **
...
### TC-LOG-04. SQL-инъекция в поле Email
...
### TC-LOG-06. Чувствительность к регистру в Email
